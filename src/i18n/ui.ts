...
export interface FooterStrings {
  ...
  productTitle: string;
  product: { capabilities: string; features: string; mobile: string; security: string; download: string; faq: string };
...
export const UI: Record<LangCode, UIStrings> = {
  zh: {
    nav: { capabilities: '核心能力', features: '产品一览', mobile: '平板与手机', security: '安全模型', docs: '文档', quickstart: '快速上手', download: '下载', faq: 'FAQ' },
    ...
    footer: {
      ...
      productTitle: '产品',
      product: { capabilities: '核心能力', features: '产品一览', mobile: '平板与手机', security: '安全模型', download: '下载', faq: '常见问题' },
      resourcesTitle: '资源',
  ...
  en: {
    nav: { capabilities: 'Capabilities', features: 'Tour', mobile: 'Mobile', security: 'Security', docs: 'Docs', quickstart: 'Get Started', download: 'Download', faq: 'FAQ' },
    ...
    footer: {
      ...
      product: { capabilities: 'Capabilities', features: 'Product Tour', mobile: 'Tablet & Phone', security: 'Security Model', download: 'Download', faq: 'FAQ' },
  ...
  ja: {
    nav: { capabilities: '主な機能', features: 'ツアー', mobile: 'モバイル', security: 'セキュリティ', docs: 'ドキュメント', quickstart: 'はじめる', download: 'ダウンロード', faq: 'FAQ' },
    ...
    footer: {
      ...
      productTitle: '製品',
      product: { capabilities: '主な機能', features: 'プロダクトツアー', mobile: 'タブレットとスマホ', security: 'セキュリティモデル', download: 'ダウンロード', faq: 'FAQ' },
      resourcesTitle: 'リソース',
  ...
  ru: {
    nav: { capabilities: 'Возможности', features: 'Обзор', mobile: 'Мобильные', security: 'Безопасность', docs: 'Документация', quickstart: 'Старт', download: 'Скачать', faq: 'Вопросы' },
    ...
    footer: {
      ...
      product: { capabilities: 'Возможности', features: 'Обзор продукта', mobile: 'Планшет и телефон', security: 'Модель безопасности', download: 'Скачать', faq: 'Вопросы' },
